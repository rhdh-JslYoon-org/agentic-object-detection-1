...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/agentic-object-detection-1](https://github.com/rhdh-JslYoon-org/agentic-object-detection-1)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/agentic-object-detection-1-gitops](https://github.com/rhdh-JslYoon-org/agentic-object-detection-1-gitops)

# **Usage**

To access the agentic-object-detection-1 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of openshift-gitops. You can access this namespace through the web console or via your CLI.
