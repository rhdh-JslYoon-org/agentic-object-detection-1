...
2) Go to the `Data Science Projects` section and access your application's project named `openshift-gitops`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `agentic-object-detection-1-notebook`.
...
5) In the terminal, run `cd agentic-object-detection-1` to navigate to your sample app's directory.
